...
var styleCache_GlobalFoyer15={}
var style_GlobalFoyer15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = '';
        ...
        function rules_GlobalFoyer15(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (GlobalFoyer15rule0_eval_expression(context)) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(253,255,235,0.5)'})
                    ...
                    else if (GlobalFoyer15rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,251,185,0.5)'})
                    ...
                    else if (GlobalFoyer15rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,217,140,0.5)'})
                    ...
                    else if (GlobalFoyer15rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,131,23,0.5)'})
                    ...
                    else if (GlobalFoyer15rule4_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_GlobalFoyer15(feature, value);
        ;
    if ("" !== null) {
    ...
    if (!styleCache_GlobalFoyer15[key]){
        ...
        styleCache_GlobalFoyer15[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_GlobalFoyer15[key]];
