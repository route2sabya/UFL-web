...
var styleCache_AnsalPlaza24={}
var style_AnsalPlaza24 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = '';
        ...
        function rules_AnsalPlaza24(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (AnsalPlaza24rule0_eval_expression(context)) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(253,255,214,0.5)'})
                    ...
                    else if (AnsalPlaza24rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,243,185,0.5)'})
                    ...
                    else if (AnsalPlaza24rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,195,131,0.5)'})
                    ...
                    else if (AnsalPlaza24rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,125,39,0.5)'})
                    ...
                    else if (AnsalPlaza24rule4_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_AnsalPlaza24(feature, value);
        ;
    if ("" !== null) {
    ...
    if (!styleCache_AnsalPlaza24[key]){
        ...
        styleCache_AnsalPlaza24[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_AnsalPlaza24[key]];
