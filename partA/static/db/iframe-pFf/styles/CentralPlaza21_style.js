...
var styleCache_CentralPlaza21={}
var style_CentralPlaza21 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = '';
        ...
        function rules_CentralPlaza21(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (CentralPlaza21rule0_eval_expression(context)) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,255,236,0.5)'})
                    ...
                    else if (CentralPlaza21rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(254,255,178,0.5)'})
                    ...
                    else if (CentralPlaza21rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,221,98,0.5)'})
                    ...
                    else if (CentralPlaza21rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(255,132,24,0.5)'})
                    ...
                    else if (CentralPlaza21rule4_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_CentralPlaza21(feature, value);
        ;
    if ("" !== null) {
    ...
    if (!styleCache_CentralPlaza21[key]){
        ...
        styleCache_CentralPlaza21[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_CentralPlaza21[key]];
